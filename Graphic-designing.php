...
<body>
    <header><h1>Graphic Design</h1>
</header>
    <main>
    <article>
    <div class="fixed">        
<form method="POST" class="example" action="Graphic-designing.php"style="margin:auto;max-width:300px;float:right;y-index:0">
    ...
    if (isset($_POST['submit'])){
        ...
        if(mysqli_num_rows($resultSet)>0){
            while($row = $resultSet->fetch_assoc()){
                if($row['developer_type']=='GraphicDesigner'){
                $d_email=$row['email'];
