...
<body>
    <header><h1>Video Editing</h1>
</header>
    <main>
    <article>
    <div class="fixed">        
<form method="POST" class="example" action="Video-editing.php"style="margin:auto;max-width:300px;float:right;y-index:0">
    ...
    if (isset($_POST['submit'])){
        ...
        if(mysqli_num_rows($resultSet)>0){
            while($row = $resultSet->fetch_assoc()){
                if($row['developer_type']=='VedioEditor'){
                $d_email=$row['email'];
